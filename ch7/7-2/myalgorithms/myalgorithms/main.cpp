...
#include <functional>   //用于greater函数
...
int main(int argc, char *argv[])
{
    ...
    qDebug() << endl << QString::fromLocal8Bit("std::count算法：");
    int countOf6 = std::count(list1.begin(), list1.end(), 6); // 查找6的个数
    qDebug() << "countOf6: " << countOf6; // 结果为3

    qDebug() << endl << QString::fromLocal8Bit("std::lower_bound算法：");
